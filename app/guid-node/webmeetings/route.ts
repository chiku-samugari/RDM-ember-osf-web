...
import GuidNodeWebMeetings from './controller';

export default class GuidNodeWebMeetingsRoute extends Route.extend(ConfirmationMixin, {}) {
    @service analytics!: Analytics;

    model(this: GuidNodeWebMeetingsRoute) {
    ...
    get isPageDirty() {
        const controller = this.controller as GuidNodeWebMeetings;
